export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do PeekNook não pôde ser alcançado",
    ...
    docLink: "Documentação do PeekNook",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o PeekNook exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do PeekNook está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no PeekNook",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O PeekNook pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no PeekNook.",
