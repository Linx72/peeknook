...
echo "  Required updater: TAURI_SIGNING_PRIVATE_KEY, TAURI_SIGNING_PRIVATE_KEY_PASSWORD"
echo "  Required macOS: APPLE_CERTIFICATE, APPLE_CERTIFICATE_PASSWORD, KEYCHAIN_PASSWORD, APPLE_ID, APPLE_PASSWORD, APPLE_TEAM_ID"
echo "  Required Windows: WINDOWS_CERTIFICATE, WINDOWS_CERTIFICATE_PASSWORD"
echo ""
echo "▶ Ship commands"
