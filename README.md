...
Current release: [v0.2.3](https://github.com/Linx72/peeknook/releases/latest) (ship: `./scripts/peeknook-ship-release.sh 0.2.3`; manual gates: `./scripts/peeknook-manual-gates.sh`). In-app auto-update fetches `latest.json` from GitHub Releases.
