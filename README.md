...
Current release: [v0.2.0](https://github.com/Linx72/peeknook/releases/tag/v0.2.0). In-app auto-update fetches `latest.json` from GitHub Releases (repo is public).
...
./scripts/peeknook-ship-check.sh       # pre-release: build + field test + ship hints
```
