...
for path in \
  ...
  ui/src/lib/releaseAssets.ts \
  ui/src/components/ReleaseDownloads.tsx \
  ...
  ui/src/components/SyncNavBadge.tsx \
  ui/src/components/SyncConflictsPanel.tsx \
  ui/src/App.tsx \
  api/routers/peeknook.py \
  ui/src/pages/CloudSync.tsx \
  ui/src/pages/Home.tsx \
  ui/src/pages/Settings.tsx \
  ui/src/api.ts \
  ui/src/components/AppUpdater.tsx \
  ui/src/i18n/en.ts \
  ui/src/i18n/ru.ts \
