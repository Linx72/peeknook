...
Current release: [v0.2.5](https://github.com/Linx72/peeknook/releases/latest) (ship: `./scripts/peeknook-ship-release.sh 0.2.5`; gates: `./scripts/peeknook-manual-gates.sh`).
