...
export default function CloudSync() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-stone-200 bg-white p-4 text-sm space-y-2 max-w-lg">
        <p className="font-medium text-stone-800">{c.twoMacStepsTitle}</p>
        <ol className="list-decimal list-inside text-xs text-stone-600 space-y-1">
          <li>{c.twoMacStepA}</li>
          <li>{c.twoMacStepB}</li>
          <li>{c.twoMacStepRecord}</li>
        </ol>
      </section>
