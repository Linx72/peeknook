...
Current release: [v0.2.7](https://github.com/Linx72/peeknook/releases/latest) (ship: `./scripts/peeknook-ship-release.sh 0.2.7`; gates: `./scripts/peeknook-gates-status.sh`).
