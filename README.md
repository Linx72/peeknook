...
Current release: [v0.2.4](https://github.com/Linx72/peeknook/releases/latest) (ship: `./scripts/peeknook-ship-release.sh 0.2.4`; VPS: `PEEKNOOK_VPS_SSH=user@host ./scripts/peeknook-vps-deploy.sh`). In-app auto-update fetches `latest.json` from GitHub Releases.
