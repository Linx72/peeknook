...
- [x] GitHub Release CI triggered: [run](https://github.com/Linx72/peeknook/actions/runs/28172208193)
- [ ] Verify `peeknook-verify-release.sh` after CI publishes v0.2.1
...
- [ ] `./scripts/peeknook-verify-release.sh` once v0.2.1 assets live
- [ ] Optional local DMG: `PEEKNOOK_SHIP_LOCAL=1 ./scripts/peeknook-ship-release.sh 0.2.1`
