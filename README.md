...
Current release: [v0.2.2](https://github.com/Linx72/peeknook/releases/latest) (ship: `./scripts/peeknook-ship-release.sh 0.2.2`; local DMG: `PEEKNOOK_SHIP_LOCAL=1 ./scripts/peeknook-ship-release.sh 0.2.2`). In-app auto-update fetches `latest.json` from GitHub Releases.
