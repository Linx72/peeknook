...
async def ship_status() -> Dict[str, Any]:
    ...
    gates = [
        {"id": "physical_two_mac", "done": physical.get("done", False), "automated": True},
        {"id": "cloud_configured", "done": bool(cloud.get("configured") and cloud.get("ok")), "automated": True},
        {"id": "handoff_ready", "done": handoff.get("available", False), "automated": True},
        {"id": "stripe_live", "done": stripe_live, "automated": True},
        {"id": "vps_deploy", "done": vps_prod, "automated": True},
        {"id": "apple_notarize", "done": apple_secrets, "automated": True},
    ]
